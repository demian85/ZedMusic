...
/**
 * Enable CSS autoload. 
 * When a View is instantiated, a CSS file with the same name as the controller will be searched inside views.default_css_dir using the same controller's path.
 ...
 */
'global_js'			=> array(
	'/scripts/jquery/jquery-1.4.2.min.noconflict.js',
	'/scripts/jquery.cooquery.min.js',
...
'title_suffix'		=> '',
/**
 * Default doctype. If empty, XHTML Strict DTD is used.
 */
'doctype'			=> '',
/**
