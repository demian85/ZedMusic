...
/**
 * This value tells the front controller what to do when an invalid or inexistent controller is requested.
 * Valid values are:
 * 1) redirect: redirects to default controller for detected module
 * 2) 404: send 404 not found header and render 404 view if provided
 */
'controllers.onerror'	=> 'redirect',
